...
int main()
{
    ...
    cout << "  2.  A good player against a mediocre player" << endl;
    cout << "  3.  A " << NTRIALS
    ...
    else if (line[0] == '3')
    {
        ...
        for (int k = 1; k <= NTRIALS; k++)
        {
            ...
            Game g(10, 10);
            addStandardShips(g);
            Player* p1 = createPlayer("mediocre", "mediocre milly", g);
...
Player *m_std = createPlayer("human", "paul", g_std);
Player *good = createPlayer("human", "ingrid", g_std);
